...
const buttonSubmitProfile = popupFormProfile.querySelector('.button__form_type_save');
...
const buttonSubmitCard = popupFormCard.querySelector('.button__form_type_create');
